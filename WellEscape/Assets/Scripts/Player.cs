...
public class Player : MonoBehaviour
{
    ...
    public Transform groundCheck; //definida pela posição do Gameobjetic "GroundCheck" do Player,
    public Transform axeAttack;   //definida pela posição do Gameobjectic "AxeAttack" do Player
    ...
    private void Aminacao(float h){                                 //CONTROLE DAS ANIMAÇÕES DO PLAYER
